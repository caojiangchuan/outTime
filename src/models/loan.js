import { getCarousel, getCustomerInfo, sendSms, validMobileCode, getMobileInfo, getCarrier, postApplyInfo, sendMSG } from '../services/loan';
...
export default {
    ...
    effects: {
        ...
        *fetch({payload, callback}, { call, put }) {
            const response = yield call(getCarousel, payload);
            yield put({
                type: 'save',
                payload: response,
            });
